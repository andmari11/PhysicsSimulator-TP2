...
//-i resources/examples/input/ex1.json -o resources/examples/expected_output/out -s 1000 -dt 1000 -fl mtfp
import java.io.File;
...
public class Main {
	...
	private static Options buildOptions() {
		...
		cmdLineOptions.addOption(Option.builder("gui").longOpt("mode").hasArg().desc(
	...
	private static void parseModeOption(CommandLine line) throws ParseException {
		...
		_gui = line.getOptionValue("gui");

		if (_gui != null && !_gui.equals("batch") && !_gui.equals("gui")) {

			throw new ParseException("Modo invalido: " + _gui);
		}
